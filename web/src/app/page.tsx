...
export default function Home() {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_70%_20%,oklch(0.9_0.08_210),transparent_34%),linear-gradient(90deg,white,oklch(0.98_0.012_220)_45%,white)] text-foreground">
      <AppNav />
      <section className="mx-auto flex max-w-5xl flex-col gap-10 px-4 md:px-6">
        <div
          id="how-it-works"
          className="relative mx-auto grid min-h-[calc(100vh-5rem)] w-full max-w-5xl scroll-mt-28 items-center gap-6 overflow-hidden pb-10 pt-12 text-center md:mx-0 md:grid-cols-[minmax(0,1.15fr)_minmax(220px,0.85fr)] md:text-left"
        >
